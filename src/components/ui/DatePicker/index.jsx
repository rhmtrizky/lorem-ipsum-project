...
const DatePicker = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i <= lastOfPrevMonth.getDay(); i++) {
      ...
      datesArray.push(
        <button key={`prev-${i}`} disabled className="prev-month">
          {text}
        </button>
      );
    }
    ...
    for (let i = firstOfNextMonth.getDay(); i < 7; i++) {
      ...
      datesArray.push(
        <button key={`next-${i}`} disabled className="next-month">
          {text}
        </button>
      );
    }
  ...
  return (
    <div className="datepicker-container w-full">
        <div className="w-full" >
            <label form="tanggal-lahir" className="mb-2 text-sm sr-only" >Tanggal Lahir</label>
        ...
        {isDatePickerVisible && (
            <div className="datepicker">
                <div className="flex items-center datepicker-header">
                    <button type="button" className="font-box-icon" onClick={handlePrev}>
                    ...
                    <button type="button" className="font-box-icon" onClick={handleNext}>
                ...
                <div className="datepicker-footer">
                    <button className="cancel" onClick={() => setDatePickerVisible(false)}>
                    Cancel
                    </button>
