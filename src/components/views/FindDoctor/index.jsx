    ...
    return (
        <>
            ...
            <section className='m-3 min-h-screen ' >
                <div>
                    <h1>Cari Dokter</h1>
                    <p>Semua dokter berpraktik setiap hari, terdiri dari dokter spesialis, subspesialis sehingga Anda bisa bertemu anggota tim setiap saat. Bekerja secara tim, dari berbagai spesialis multidisplinier, dokter dapat memberikan jalan keluar yang komprehensif untuk setiap masalah yang Anda alami.</p>
                </div>            
                <form className='w-full flex gap-2 mb-8' >
                {/* fungsi sr-only */}
