            ...
            <section className='w-full min-h-screen overflow-hidden mb-8'>
                ...
                <div className='flex max-[1000px]:flex-col min-[1550px]:justify-center items-center mt-10 min-[405px]:mt-20'>
                    <div className='relative min-[1000px]:mr-12'>
                        <Image src={administrationImage} width={700} height={500} alt='administration-image.png' loading='lazy' className='max-[400px]:w-[300px] max-[710px]:w-[400px] mx-6' />
                        <Image src={dots} width={150} height={200} alt='dots.png' loading='lazy' className=' max-[700px]:w-[80px] max-[700px]:-bottom-10 absolute -bottom-20' />
