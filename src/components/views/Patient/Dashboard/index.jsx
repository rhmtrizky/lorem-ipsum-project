...
//                             <Link href={'/patient/dashboard/schedule'} className='flex items-center justify-center gap-2 text-sm ' >
//                                 <i class='bx bxs-calendar'></i>
//                                 Antrian
//                             </Link>
//                             <Link href={'/patient/dashboard/family'} className='flex items-center justify-center gap-2 text-sm' >
//                                 <i class='bx bxs-user-plus'></i>
//                                 Anggota Keluarga
//                             </Link>
//                             <div className=' p-4 border-2 border-purple-900 mt-4  ' >
//                                 Tiket
//                             </div>
//                         </div>
//                     </div>
